...
const Footer = () => {
    return (
        <div>
            <footer className="footer flex justify-between items-center p-4 bg-purple-900 text-neutral-content">
                <div className="items-center grid-flow-col">
                    <Link to='/'><img className='lg:w-20 md:w-20 w-10 m-0 p-0' src={img} alt="" /></Link>
